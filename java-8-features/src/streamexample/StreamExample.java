...
//        stringStream3.forEach(s3 -> System.out.println("s3 in the stream - " + s3));
        ...
        String[] friendList = new String[]{"Nikhil", "Sahil", "Karan", "Ashish"};
        ...
        System.out.println("##########################################################");
        stringStream = Stream.of("Nikhil", "Mike", "Bob");
        stringStream.forEach(System.out::println);
        ...
        studentList.add(new Student("Nikhil", 26));
        studentList.add(new Student("Mike", 23));
        studentList.add(new Student("Bob", 27));
        studentList.add(new Student("Sahil",23));
        studentList.add(new Student("Ashish", 24));
